...
const s = {
  ...
  avatarLg: { width: 80, height: 80, borderRadius: "50%", background: "#3dff3a", color: "#000", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 800, fontSize: 30 },
  avatarSm: { width: 30, height: 30, borderRadius: "50%", background: "#3aff54", color: "#000", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 800, fontSize: 12 },
  ...
  tabActive: { color: "#3aff6e", borderBottomColor: "#5bff3a" },
